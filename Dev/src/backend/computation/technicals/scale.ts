// Axis / scale utilities — Heckbert "nice numbers" algorithm and tick generation.
...
/**
 * Round to a "nice" value (1, 2, 2.5, 5 scaled by power of 10).
 * `round = true` rounds to nearest; `round = false` ceilings.
 */
 ...
 * Produces clean round tick values.
 */
...
/** Convenience wrapper for a flat array of values; filters non-finite. */
